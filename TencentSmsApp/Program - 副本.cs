...
namespace TencentSmsApp
{
    class SendSms
    {
        static void Main(string[] args)
        {
            try
            {
                ...
                * sms helper：https://cloud.tencent.com/document/product/382/3773 */
                ...
                req.SmsSdkAppid = "1400293811";
                /* 短信签名内容: 使用 UTF-8 编码，必须填写已审核通过的签名，可登录 [短信控制台] 查看签名信息 */
                string s1= HttpUtility.UrlEncode("峨眉山奇门", Encoding.UTF8);
                string s2 =HttpUtility.UrlEncode("峨眉山奇门", Encoding.GetEncoding("utf-8"));
                //string s3 = GetUTF8("峨眉山奇门");
                string s4 = GetUTF82("峨眉山奇门");
                string s5 = GetUTF83("峨眉山奇门");
                //req.Sign = HttpUtility.UrlEncode("峨眉山奇门", Encoding.UTF8); 
                //req.Sign = "峨眉山奇门";
                req.Sign = "峨眉山奇门";
                ...
                req.PhoneNumberSet = new String[] { "+8615882483206" };
                /* 模板 ID: 必须填写已审核通过的模板 ID，可登录 [短信控制台] 查看模板 ID */
                req.TemplateID = "489989";
                /* 模板参数: 若无模板参数，则设置为空*/
                req.TemplateParamSet = new String[] { "123456" };
                ...
                // 输出 JSON 格式的字符串回包
                //var resJson = AbstractModel.ToJsonString(resp);
        ...
        static string GetUTF83(string strcode)
        {
        ...
        static string GetUTF82(string unicodeString)
        { 
        ...
        static string GetUTF8(string str)
        {
            ...
            UTF8Encoding utf8 = new UTF8Encoding();
            Byte[] encodedBytes = utf8.GetBytes(str);//编码
            ...
            string newFileName = sb.ToString();//新文件名
            return sb.ToString();
        }
    }
}
