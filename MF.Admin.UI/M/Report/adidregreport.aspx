<%@ Page Title="报表管理 》 渠道注册报表" Language="C#" MasterPageFile="~/M/main.Master" AutoEventWireup="true"  CodeBehind="baiduadreport.aspx.cs" Inherits="MF.Admin.UI.M.Report.baiduadreport" %>
<asp:Content ID="Content1" ContentPlaceHolderID="h" runat="server">
    <script language="javascript" type="text/javascript">
        ...
        function search() {
            ...
            ajax.getadidregReport(jsonPager.makeArgs(1), searchResult);
        }
        ...
        $(document).ready(function() {
            ...
            showTimeBox($$("time"));
            var pagerTitles = ["日期", "渠道", "设备","游戏","注册数量", "ADID"];
            jsonPager.init(ajax.getadidregReport, [], searchResult, pagerTitles, "list_table", "container", "pager", insertRow);
            jsonPager.dataBind(1, 0);
        });
    </script>
</asp:Content>
<asp:Content ID="Content2" ContentPlaceHolderID="p" runat="server">
            <div class="toolbar">渠道注册报表</div>
            <div class="search">&nbsp;&nbsp;
                <select id="channel">
