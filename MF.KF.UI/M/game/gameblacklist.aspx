<%@ Page Title=" 游戏管理 》 黑名单列表" MasterPageFile="~/M/main.Master"  Language="C#" AutoEventWireup="true" CodeBehind="gameblacklist.aspx.cs" Inherits="MF.KF.UI.M.game.gameblacklist" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="p" runat="server">
    ...
    <div class="loading" id="loading"></div>
     <!--弹出窗口开始-->
    <div class="theme-popover" style="height: 510px;">
