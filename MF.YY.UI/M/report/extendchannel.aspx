<%@ Page  Title=" 报表管理 》 推广页面渠道报表" MasterPageFile="~/M/main.Master" Language="C#" AutoEventWireup="true" CodeBehind="extendchannel.aspx.cs" Inherits="MF.YY.UI.M.report.extendchannel" %>
<asp:Content ID="Content1" ContentPlaceHolderID="h" runat="server">
    <script language="javascript" type="text/javascript">         
        function searchRedis() {
            $("#loading").show();
            var args = [$("#channellist").val(), "", 2, 0, 0];
        ...
        $(document).ready(function () {
            ...
            {
                if (i == 0)
                    $("#channellist").append("<option value=\"" + id + "\" selected=\"selected\">" + channelconst[id] + "</option>");
                else
                    $("#channellist").append("<option value=\"" + id + "\">" + channelconst[id] + "</option>");
                i++;
            }
