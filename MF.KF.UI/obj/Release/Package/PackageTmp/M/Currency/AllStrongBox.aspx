...
<asp:Content ID="Content1" ContentPlaceHolderID="h" runat="server">
    <script language="javascript" type="text/javascript">
        ...
        $(document).ready(function () {
            var baseD = new Date("2020/03/07 00:00:00");
            var minday = Math.floor(new Date() / 86400000) - Math.floor(baseD.getTime() / 86400000);
            attachCalenderbox('#starttime', '#overtime', { minday: minday }, new Date().Format("yyyy-MM-dd"), new Date().Format("yyyy-MM-dd"));
            showTimeBox($$("time"));
