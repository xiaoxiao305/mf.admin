<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="top.aspx.cs" Inherits="MF.Admin.UI.M.top" %>
            ...
            <td><table width="100%" border="0" cellspacing="0" cellpadding="0">
              ...
              <tr>
                <td height="50" align="left" valign="bottom">
			        <div class="topmenu">
			            <ul>
			                <li><span onclick="selectMenu(0,'/m/users/userlist.aspx')">用户管理</span></li>
				            <li><span onclick="selectMenu(1,'/m/charge/RecordList.aspx')">充值管理</span></li>
                            <li><span onclick="selectMenu(2,'/m/guild/GuildList.aspx')">俱乐部管理</span></li>
				            <li><span onclick="selectMenu(3,'/m/report/Game.aspx')">游戏管理</span></li>
                            <li><span onclick="selectMenu(4,'/m/report/RegReport.aspx')">报表管理</span></li>
                            <li><span onclick="selectMenu(5,'/m/SysManage/oprlog.aspx')">系统管理</span></li>
			            </ul>
			        </div>
			    </td>
              </tr>
