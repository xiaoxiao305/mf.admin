<%@ Page Title=" 俱乐部管理》俱乐部活跃" MasterPageFile="~/M/main.Master" Language="C#" AutoEventWireup="true"  %>
<asp:Content ID="Content1" ContentPlaceHolderID="h" runat="server">
    ...
    <script language="javascript" type="text/javascript">
        ...
        function insertRow(o, tr) {
            ...
            addCell(tr, "<a href ='/m/club/guildlist.aspx?club_id=" + o.club_id + "' target='main' class='white'>" + o.club_id + "</a>", 0);
