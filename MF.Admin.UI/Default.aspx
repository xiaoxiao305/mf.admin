<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="Default.aspx.cs" Inherits="MF.Admin.UI._Default" %>

<%@ Register Assembly="MF.WebControls" Namespace="MF.WebControls" TagPrefix="mf" %>
<!DOCTYPE html PUBLIC "-//W3C//DTD XHTML 1.0 Transitional//EN" "http://www.w3.org/TR/xhtml1/DTD/xhtml1-transitional.dtd">
<html xmlns="http://www.w3.org/1999/xhtml" >
<head runat="server">
    <title>2255棋牌后台管理系统</title>
...
<body>
    <form id="form1" runat="server">
        <object id="hd" classid="clsid:BDFBCF85-06FB-43a0-9B99-83C6C60BE7C6" style="display:none;"></object>
