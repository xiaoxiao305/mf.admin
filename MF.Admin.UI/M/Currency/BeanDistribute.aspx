<%@ Page Title="游戏币管理》金豆分布报表" Language="C#" MasterPageFile="~/M/main.Master" AutoEventWireup="true" CodeBehind="BeanDistribute.aspx.cs" Inherits="MF.Admin.UI.M.Currency.BeanDistribute" %>
<asp:Content ID="Content1" ContentPlaceHolderID="h" runat="server">
    <script language="javascript" type="text/javascript">
        function search() {
            ...
            $("#loading").show();
            var args = ["beandistribute", startTime, overTime];
        ...
        $(document).ready(function() {
            ...
            var pagerTitles = ["日期", "0金豆/人数", "1～1000金豆/人数", "1001～5000金豆/人数", "5001～2万/人数", "2万～10万/人数", "10万～100万/人数", "100万以上/人数"];
