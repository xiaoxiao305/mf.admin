<%@ Page Title="报表管理 》 游戏巡场" MasterPageFile="~/M/main.Master" Language="C#" AutoEventWireup="true" CodeBehind="autopatrol.aspx.cs" Inherits="MF.Admin.UI.M.game.autopatrol" %>
    ...
    <script language="javascript" type="text/javascript">   
        ...
        function insertRow(o, tr) {
            ...
            for (var n in o.NickNamesNew) {
                nickStr += "<a href='/M/currency/CurrencyRecord.aspx?chargeid=" + o.ChargeIds[n] + "' target='_blank'>" + initNick(n) + "</a><br/>";
            }
