<%@ Page Title=" 系统管理 》 管理员操作日志" Language="C#" MasterPageFile="~/M/main.Master" AutoEventWireup="true" CodeBehind="SystemLogList.aspx.cs" Inherits="MF.Admin.UI.M.Manager.SystemLogList" %>
<asp:Content ID="Content1" ContentPlaceHolderID="h" runat="server">
    <script language="javascript" type="text/javascript">
        function search() {
            ...
            var args = ["system", exact, parseInt($("#filed").val()), $("#key").val(), startTime, overTime];
        ...
        function insertRow(o,tr) {
            ...
            addCell(tr, date.dateAdd("s", o.LogTime).format("yyyy-MM-dd hh:mm:ss"), 1);
            addCell(tr, o.IP, 2);
            addCell(tr, o.Page, 3);
            addCell(tr, o.Content, 4);
            return tr;
        }
        $(document).ready(function() {
            attachCalenderbox('#starttime', '#overtime', null, new Date().dateAdd("d", -7).Format("yyyy-MM-dd"), new Date().Format("yyyy-MM-dd"));
            var pagerTitles = ["账号", "操作时间", "IP", "页面/方法", "操作内容"];
...
<asp:Content ID="Content2" ContentPlaceHolderID="p" runat="server">
            <div class="toolbar">查看管理员操作日志</div>
            <div class="search">&nbsp;&nbsp;
