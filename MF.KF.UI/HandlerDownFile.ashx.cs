            ...
            try
            {
                ...
                }else if (m == 2)//全部
                {
                    ...
                    for (int i = 0; i < days; i++)
                    {
                        ...
                        string filePath = string.Format("{0}record/{1}/{2}/ALL/{3}_ERROR_{4}.txt", recUri, gameId, chargeId, type, day);//LOG_ERROR_2020-02-27.txt REC_ERROR_2020-05-31.txt 异常LOG-REC 2020-05-27|2020-05-31 @李文波
