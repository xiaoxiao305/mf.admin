<%@ Page Title=" 报表管理 》 每日注册报表" Language="C#" MasterPageFile="~/M/main.Master" AutoEventWireup="true" CodeBehind="Regist.aspx.cs" Inherits="MF.Admin.UI.M.Report.Regist" %>
<asp:Content ID="Content1" ContentPlaceHolderID="h" runat="server">
    <script language="javascript" type="text/javascript">
        function search() {
            ...
            $("#loading").show();
            var args = ["regist",startTime, overTime];
