<%@ Page Title="游戏币管理》金券分布" Language="C#" MasterPageFile="~/M/main.Master" AutoEventWireup="true" CodeBehind="GoldDistribute.aspx.cs" Inherits="MF.Admin.UI.M.Currency.GoldDistribute" %>
<asp:Content ID="Content1" ContentPlaceHolderID="h" runat="server">
    <script language="javascript" type="text/javascript">
        function search() {
            ...
            $("#loading").show();
            var args = ["golddistribute", startTime, overTime];
        ...
        $(document).ready(function() {
            ...
            var pagerTitles = ["日期", "0金券/人数", "1～100金券/人数", "101～500金券/人数", "501～2000金券/人数", "2000～1万/人数", "1万～5万/人数", "5万以上/人数"];
