<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="top.aspx.cs" Inherits="MF.KF.UI.M.top" %>
...
<head id="Head1" runat="server">
    ...
    <script language="javascript" type="text/javascript"  src="/common/js/ajax.js?v=1.6"></script>
                ...
                <td height="50" align="left" valign="bottom">
			        <div class="topmenu">
			            <ul>
                            ...
                            <li><span onclick="selectMenu(3,'/m/report/promot.aspx')">报表管理</span></li>
                            <li><span onclick="selectMenu(4,'/m/SysManage/sendbroadcast.aspx')">系统管理</span></li>
			            </ul>
			        </div>
			    </td>
              </tr>
